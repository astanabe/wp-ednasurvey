    ...
    public static function get_standard_field_definitions(): array {
        return array(
            ...
            'survey_date'    => array(
                ...
                'description_local' => '西暦',
                'description_en'    => 'Gregorian calendar',
            ...
            'survey_time'    => array(
                ...
                'description_local' => '現地時間',
                'description_en'    => 'Local time',
                'example_local'     => '10:30',
                'example_en'        => '10:30',
                'is_custom'         => false,
            ),
            ...
            // Water/air/container filtration & measurement fields are NOT defined
            // here. They are managed by EdnaSurvey_Filter_Fields and stored in the
            // ednasurvey_site_filters child table (variable count per type).
            'filter_name'    => array(
                'key'               => 'filter_name',
