...
$content_callback = function () use ( $username ) {
    ...
    <div class="ednasurvey-template-download">
        ...
        <p class="ednasurvey-help" style="margin-bottom: 1.5em;">
            <?php esc_html_e( 'It may take a moment before the download starts.', 'wp-ednasurvey' ); ?>
        </p>
        ...
        <h3><?php esc_html_e( 'About Environment, Weather, and Wind', 'wp-ednasurvey' ); ?></h3>
        <ul>
            <li><?php esc_html_e( '"estuarine" in the Environment (Broad) field: does not include areas outside the river mouth, even if nearby.', 'wp-ednasurvey' ); ?></li>
            <li><?php esc_html_e( '"mangrove" in the Environment (Broad) field: mangroves in estuarine areas should be classified as mangrove.', 'wp-ednasurvey' ); ?></li>
            <li><?php esc_html_e( '"large river" in the Environment (Broad) field: whether a sightseeing boat can operate (rapids boats do not count).', 'wp-ednasurvey' ); ?></li>
            <li><?php esc_html_e( '"saline lake" in the Environment (Broad) field: does not include brackish lakes or lagoons.', 'wp-ednasurvey' ); ?></li>
            <li><?php esc_html_e( '"sterile water" in the Environment (Broad) field: for blanks / negative controls.', 'wp-ednasurvey' ); ?></li>
            <li><?php esc_html_e( '"windy" in the Wind field: select "windy" if a syringe or filter holder used for filtration is continuously moved by the wind.', 'wp-ednasurvey' ); ?></li>
        </ul>
